    ...
    <div class="slider-menu">
        <div class="row h-100 align-items-center justify-content-center text-center">
            <div class="col-lg-10 align-self-center">
                <h1 class="text-white font-weight-bold">Ujian Saringan Mandiri
                </h1>
            </div>
        </div>
    </div>
        ...
        <div class="mt-3 pt-3">
                ...
                <tbody>
                    <?php foreach ($jalur as $jl) : ?>
                        <tr>
                            ...
                            $uji = strtotime($jl['ujian']);
                            $ujian = date('d M Y', $uji);
            ...
            <div class="card" style="width: 900px;">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <?php $kode = 0;
                        if (strtotime($jl['pendaftaran_ak']) >= strtotime('now') && strtotime('now') >= strtotime($jl['pendaftaran_aw'])) {
                            $kode = $jl['id_jalur'];
                        }
                        ?>
